# TrakHound.Function.Template
Create a .NET Project template for a TrakHound Function module. Function modules are used to create a short-lived process in TrakHound. Functions are typically used to process or import data and can be run manually or run at a specified interval.
...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><img src="https://img.shields.io/nuget/dt/TrakHound.Function.Template?style=for-the-badge&logo=nuget&label=%20&color=%23333"/></td>
            <td><a href="https://www.nuget.org/packages/TrakHound.Function.Template">https://www.nuget.org/packages/TrakHound.Function.Template</a></td>
        </tr>
    </tbody>
</table>
...
#### Install Template
Use the **[dotnet CLI](https://learn.microsoft.com/en-us/dotnet/core/tools/)** to install the TrakHound.Function.Template using the below command:
```
dotnet new install TrakHound.Function.Template
```

#### Create New Project
This will create a new project using the template in the current working directory
```
dotnet new trakhound.function
```
