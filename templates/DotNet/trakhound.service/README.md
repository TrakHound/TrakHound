...
<table>
    ...
    <tbody>
        <tr>
            ...
            <td><img src="https://img.shields.io/nuget/dt/TrakHound.Service.Template?style=for-the-badge&logo=nuget&label=%20&color=%23333"/></td>
            <td><a href="https://www.nuget.org/packages/TrakHound.Service.Template">https://www.nuget.org/packages/TrakHound.Service.Template</a></td>
        </tr>
    </tbody>
</table>
...
#### Install Template
Use the **[dotnet CLI](https://learn.microsoft.com/en-us/dotnet/core/tools/)** to install the TrakHound.Service.Template using the below command:
```
dotnet new install TrakHound.Service.Template
```
