...
{
    internal partial class TrakHoundInstanceSystemObjectEventClient
    {
           ...
           string routerId = null)
        {
            ...
            if (router != null)
            {
                var response = await router.Entities.Objects.Events.QueryByRange(queries, skip, take, sortOrder);
