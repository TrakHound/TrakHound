...
{
    internal partial class TrakHoundInstanceSystemObjectObservationClient
    {
           ...
           string routerId = null)
        {
            ...
            if (router != null)
            {
                var response = await router.Entities.Objects.Observations.QueryByRange(queries, skip, take, sortOrder);
