...
{
    [ApiController]
    [Route($"{HttpConstants.EntitiesPrefix}/objects/blob")]
    public abstract class TrakHoundObjectBlobControllerBase : TrakHoundHttpEntityControllerBase<ITrakHoundObjectBlobEntity>
    {
        public TrakHoundObjectBlobControllerBase(ITrakHoundInstance instance, TrakHoundHttpWebSocketManager webSocketManager) : base(instance, webSocketManager) { }
