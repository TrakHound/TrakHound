...
{
    [ApiController]
    [Route($"{HttpConstants.EntitiesPrefix}/objects/boolean")]
    public abstract class TrakHoundObjectBooleanControllerBase : TrakHoundHttpEntityControllerBase<ITrakHoundObjectBooleanEntity>
    {
        public TrakHoundObjectBooleanControllerBase(ITrakHoundInstance instance, TrakHoundHttpWebSocketManager webSocketManager) : base(instance, webSocketManager) { }
