...
{
    public partial class TrakHoundObjectEventController
    {
        /// <summary>
        /// 
        /// </summary>
            ...
            )
        {
            ...
            if (client != null)
            {
                ...
                var entities = await client.System.Entities.Objects.Event.QueryByRange(queries, skip, take, (SortOrder)sortOrder);
