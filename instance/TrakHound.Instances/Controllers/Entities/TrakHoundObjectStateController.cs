...
{
    public partial class TrakHoundObjectStateController
    {
        /// <summary>
        /// 
        /// </summary>
            ...
            )
        {
            ...
            if (client != null)
            {
                ...
                var entities = await client.System.Entities.Objects.State.QueryByRange(queries, skip, take, (SortOrder)sortOrder);
