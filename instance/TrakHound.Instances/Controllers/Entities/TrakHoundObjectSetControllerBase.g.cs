...
{
    [ApiController]
    [Route($"{HttpConstants.EntitiesPrefix}/objects/set")]
    public abstract class TrakHoundObjectSetControllerBase : TrakHoundHttpEntityControllerBase<ITrakHoundObjectSetEntity>
    {
        public TrakHoundObjectSetControllerBase(ITrakHoundInstance instance, TrakHoundHttpWebSocketManager webSocketManager) : base(instance, webSocketManager) { }
