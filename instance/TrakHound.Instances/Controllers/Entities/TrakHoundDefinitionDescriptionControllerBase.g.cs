...
{
    [ApiController]
    [Route($"{HttpConstants.EntitiesPrefix}/definitions/description")]
    public abstract class TrakHoundDefinitionDescriptionControllerBase : TrakHoundHttpEntityControllerBase<ITrakHoundDefinitionDescriptionEntity>
    {
        public TrakHoundDefinitionDescriptionControllerBase(ITrakHoundInstance instance, TrakHoundHttpWebSocketManager webSocketManager) : base(instance, webSocketManager) { }
