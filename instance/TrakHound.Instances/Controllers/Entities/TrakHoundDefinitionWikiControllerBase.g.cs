...
{
    [ApiController]
    [Route($"{HttpConstants.EntitiesPrefix}/definitions/wiki")]
    public abstract class TrakHoundDefinitionWikiControllerBase : TrakHoundHttpEntityControllerBase<ITrakHoundDefinitionWikiEntity>
    {
        public TrakHoundDefinitionWikiControllerBase(ITrakHoundInstance instance, TrakHoundHttpWebSocketManager webSocketManager) : base(instance, webSocketManager) { }
