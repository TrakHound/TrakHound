...
{
    [ApiController]
    [Route($"{HttpConstants.EntitiesPrefix}/objects/number")]
    public abstract class TrakHoundObjectNumberControllerBase : TrakHoundHttpEntityControllerBase<ITrakHoundObjectNumberEntity>
    {
        public TrakHoundObjectNumberControllerBase(ITrakHoundInstance instance, TrakHoundHttpWebSocketManager webSocketManager) : base(instance, webSocketManager) { }
        ...
        public async Task<IActionResult> QueryByObject(
            [FromQuery] string path,
            [FromQuery] double minimum,
            [FromQuery] double maximum,
