...
{
    [ApiController]
    [Route($"{HttpConstants.EntitiesPrefix}/objects/vocabulary")]
    public abstract class TrakHoundObjectVocabularyControllerBase : TrakHoundHttpEntityControllerBase<ITrakHoundObjectVocabularyEntity>
    {
        public TrakHoundObjectVocabularyControllerBase(ITrakHoundInstance instance, TrakHoundHttpWebSocketManager webSocketManager) : base(instance, webSocketManager) { }
