...
{
    [ApiController]
    [Route($"{HttpConstants.EntitiesPrefix}/objects/message-queue")]
    public abstract class TrakHoundObjectMessageQueueControllerBase : TrakHoundHttpEntityControllerBase<ITrakHoundObjectMessageQueueEntity>
    {
        public TrakHoundObjectMessageQueueControllerBase(ITrakHoundInstance instance, TrakHoundHttpWebSocketManager webSocketManager) : base(instance, webSocketManager) { }
