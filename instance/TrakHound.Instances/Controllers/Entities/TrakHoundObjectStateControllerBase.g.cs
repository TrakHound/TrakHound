...
{
    [ApiController]
    [Route($"{HttpConstants.EntitiesPrefix}/objects/state")]
    public abstract class TrakHoundObjectStateControllerBase : TrakHoundHttpEntityControllerBase<ITrakHoundObjectStateEntity>
    {
        public TrakHoundObjectStateControllerBase(ITrakHoundInstance instance, TrakHoundHttpWebSocketManager webSocketManager) : base(instance, webSocketManager) { }
