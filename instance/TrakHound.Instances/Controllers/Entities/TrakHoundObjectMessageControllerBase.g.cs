...
{
    [ApiController]
    [Route($"{HttpConstants.EntitiesPrefix}/objects/message")]
    public abstract class TrakHoundObjectMessageControllerBase : TrakHoundHttpEntityControllerBase<ITrakHoundObjectMessageEntity>
    {
        public TrakHoundObjectMessageControllerBase(ITrakHoundInstance instance, TrakHoundHttpWebSocketManager webSocketManager) : base(instance, webSocketManager) { }
