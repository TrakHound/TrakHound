...
{
    public partial class TrakHoundObjectLogController
    {
        /// <summary>
        /// 
        /// </summary>
            ...
            )
        {
            ...
            if (client != null)
            {
                ...
                var entities = await client.System.Entities.Objects.Log.QueryByRange(queries, minLevel, skip, take, (SortOrder)sortOrder);
