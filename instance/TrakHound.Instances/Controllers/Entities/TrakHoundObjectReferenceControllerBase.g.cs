...
{
    [ApiController]
    [Route($"{HttpConstants.EntitiesPrefix}/objects/reference")]
    public abstract class TrakHoundObjectReferenceControllerBase : TrakHoundHttpEntityControllerBase<ITrakHoundObjectReferenceEntity>
    {
        public TrakHoundObjectReferenceControllerBase(ITrakHoundInstance instance, TrakHoundHttpWebSocketManager webSocketManager) : base(instance, webSocketManager) { }
