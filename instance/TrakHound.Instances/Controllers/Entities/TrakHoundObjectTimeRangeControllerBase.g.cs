...
{
    [ApiController]
    [Route($"{HttpConstants.EntitiesPrefix}/objects/time-range")]
    public abstract class TrakHoundObjectTimeRangeControllerBase : TrakHoundHttpEntityControllerBase<ITrakHoundObjectTimeRangeEntity>
    {
        public TrakHoundObjectTimeRangeControllerBase(ITrakHoundInstance instance, TrakHoundHttpWebSocketManager webSocketManager) : base(instance, webSocketManager) { }
