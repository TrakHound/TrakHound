...
{
    [ApiController]
    [Route($"{HttpConstants.EntitiesPrefix}/objects/timestamp")]
    public abstract class TrakHoundObjectTimestampControllerBase : TrakHoundHttpEntityControllerBase<ITrakHoundObjectTimestampEntity>
    {
        public TrakHoundObjectTimestampControllerBase(ITrakHoundInstance instance, TrakHoundHttpWebSocketManager webSocketManager) : base(instance, webSocketManager) { }
            ...
            )
        {
            ...
            if (client != null)
            {
                return await OnQueryByObject(client, path, from, to, objectSkip, objectTake, indentOutput);
            }
            else
            {
                return StatusCode(500, "Entity Client Not Found");
            ...
            )
        {
            ...
            if (client != null)
            {
                return await OnQueryByObject(client, paths, from, to, objectSkip, objectTake, indentOutput);
            }
            else
            {
                return StatusCode(500, "Entity Client Not Found");
            ...
            )
        {
            ...
            if (client != null)
            {
                return await OnQueryByObjectUuid(client, objectUuid, from, to, indentOutput);
            }
            else
            {
                return StatusCode(500, "Entity Client Not Found");
            ...
            )
        {
            ...
            if (client != null)
            {
                return await OnQueryByObjectUuid(client, objectUuids, from, to, indentOutput);
            }
            else
            {
                return StatusCode(500, "Entity Client Not Found");
