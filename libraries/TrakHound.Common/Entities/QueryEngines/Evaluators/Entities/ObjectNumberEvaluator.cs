...
{
    public class ObjectNumberEvaluator : EntityEvaluator, IEvaluator
    {
        public ObjectNumberEvaluator(ConditionObjectQuery query, ITrakHoundObjectEntityModel conditionObject)
        {
        ...
        public static async Task<IEnumerable<IEvaluatorResult>> Evaluate(QueryStatement statement, ITrakHoundSystemEntitiesClient client, IEnumerable<ObjectNumberEvaluator> evaluators)
        {
            ...
            {
                var entities = await client.Objects.Number.QueryByObjectUuid(evaluators.Select(o => o.ConditionObject.Uuid));
