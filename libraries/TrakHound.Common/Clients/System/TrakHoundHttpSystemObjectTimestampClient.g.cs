...
{
    internal partial class TrakHoundHttpSystemObjectTimestampClient : TrakHoundHttpEntityClientBase<ITrakHoundObjectTimestampEntity>, ITrakHoundSystemObjectTimestampClient
    {




        public TrakHoundHttpSystemObjectTimestampClient(TrakHoundHttpClient baseClient, TrakHoundHttpSystemEntitiesClient entitiesClient) : base (baseClient, entitiesClient) 
        {
        }
            ...
            string routerId = null)
        {
            ...
            var url = Url.Combine(BaseUrl, TrakHoundHttp.GetEntityPath<ITrakHoundObjectTimestampEntity>());
            ...
            string routerId = null)
        {
            ...
            route = Url.AddQueryParameter(route, "path", (string)path);
            route = Url.AddQueryParameter(route, "from", (long)from);
            route = Url.AddQueryParameter(route, "to", (long)to);
            ...
            string routerId = null)
        {
            ...
            var url = TrakHoundHttp.GetEntityPath<ITrakHoundObjectTimestampEntity>();
            url = Url.Combine(url, route);


            var consumer = new TrakHoundEntityListClientConsumer<ITrakHoundObjectTimestampEntity>(BaseClient.ClientConfiguration, url, paths);
            consumer.Subscribe();
            return consumer;
        }
            ...
            string routerId = null)
        {
            ...
            var consumer = new TrakHoundEntityListClientConsumer<ITrakHoundObjectTimestampEntity>(BaseClient.ClientConfiguration, url, objectUuids);
            consumer.Subscribe();
            return consumer;
        }
