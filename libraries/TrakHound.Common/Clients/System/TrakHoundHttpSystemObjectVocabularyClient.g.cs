...
{
    internal partial class TrakHoundHttpSystemObjectVocabularyClient : TrakHoundHttpEntityClientBase<ITrakHoundObjectVocabularyEntity>, ITrakHoundSystemObjectVocabularyClient
    {




        public TrakHoundHttpSystemObjectVocabularyClient(TrakHoundHttpClient baseClient, TrakHoundHttpSystemEntitiesClient entitiesClient) : base (baseClient, entitiesClient) 
        {
        }
            ...
            string routerId = null)
        {
            ...
            var url = Url.Combine(BaseUrl, TrakHoundHttp.GetEntityPath<ITrakHoundObjectVocabularyEntity>());
            ...
            string routerId = null)
        {
            ...
            var url = TrakHoundHttp.GetEntityPath<ITrakHoundObjectVocabularyEntity>();
            url = Url.Combine(url, route);


            var consumer = new TrakHoundEntityListClientConsumer<ITrakHoundObjectVocabularyEntity>(BaseClient.ClientConfiguration, url, paths);
            consumer.Subscribe();
            return consumer;
        }
            ...
            string routerId = null)
        {
            ...
            var consumer = new TrakHoundEntityListClientConsumer<ITrakHoundObjectVocabularyEntity>(BaseClient.ClientConfiguration, url, objectUuids);
            consumer.Subscribe();
            return consumer;
        }
