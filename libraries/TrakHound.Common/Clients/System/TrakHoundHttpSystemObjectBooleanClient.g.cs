...
{
    internal partial class TrakHoundHttpSystemObjectBooleanClient : TrakHoundHttpEntityClientBase<ITrakHoundObjectBooleanEntity>, ITrakHoundSystemObjectBooleanClient
    {




        public TrakHoundHttpSystemObjectBooleanClient(TrakHoundHttpClient baseClient, TrakHoundHttpSystemEntitiesClient entitiesClient) : base (baseClient, entitiesClient) 
        {
        }
            ...
            string routerId = null)
        {
            ...
            var url = Url.Combine(BaseUrl, TrakHoundHttp.GetEntityPath<ITrakHoundObjectBooleanEntity>());
            ...
            string routerId = null)
        {
            ...
            var url = TrakHoundHttp.GetEntityPath<ITrakHoundObjectBooleanEntity>();
            url = Url.Combine(url, route);


            var consumer = new TrakHoundEntityListClientConsumer<ITrakHoundObjectBooleanEntity>(BaseClient.ClientConfiguration, url, paths);
            consumer.Subscribe();
            return consumer;
        }
            ...
            string routerId = null)
        {
            ...
            var consumer = new TrakHoundEntityListClientConsumer<ITrakHoundObjectBooleanEntity>(BaseClient.ClientConfiguration, url, objectUuids);
            consumer.Subscribe();
            return consumer;
        }
