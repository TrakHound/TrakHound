...
{
    internal partial class TrakHoundHttpSystemObjectBlobClient : TrakHoundHttpEntityClientBase<ITrakHoundObjectBlobEntity>, ITrakHoundSystemObjectBlobClient
    {




        public TrakHoundHttpSystemObjectBlobClient(TrakHoundHttpClient baseClient, TrakHoundHttpSystemEntitiesClient entitiesClient) : base (baseClient, entitiesClient) 
        {
        }
            ...
            string routerId = null)
        {
            ...
            var url = Url.Combine(BaseUrl, TrakHoundHttp.GetEntityPath<ITrakHoundObjectBlobEntity>());
            ...
            string routerId = null)
        {
            ...
            var url = TrakHoundHttp.GetEntityPath<ITrakHoundObjectBlobEntity>();
            url = Url.Combine(url, route);


            var consumer = new TrakHoundEntityListClientConsumer<ITrakHoundObjectBlobEntity>(BaseClient.ClientConfiguration, url, paths);
            consumer.Subscribe();
            return consumer;
        }
            ...
            string routerId = null)
        {
            ...
            var consumer = new TrakHoundEntityListClientConsumer<ITrakHoundObjectBlobEntity>(BaseClient.ClientConfiguration, url, objectUuids);
            consumer.Subscribe();
            return consumer;
        }
