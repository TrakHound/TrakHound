...
{
    internal partial class TrakHoundHttpSystemDefinitionDescriptionClient : TrakHoundHttpEntityClientBase<ITrakHoundDefinitionDescriptionEntity>, ITrakHoundSystemDefinitionDescriptionClient
    {




        public TrakHoundHttpSystemDefinitionDescriptionClient(TrakHoundHttpClient baseClient, TrakHoundHttpSystemEntitiesClient entitiesClient) : base (baseClient, entitiesClient) 
        {
        }
            ...
            string routerId = null)
        {
            ...
            var url = Url.Combine(BaseUrl, TrakHoundHttp.GetEntityPath<ITrakHoundDefinitionDescriptionEntity>());
