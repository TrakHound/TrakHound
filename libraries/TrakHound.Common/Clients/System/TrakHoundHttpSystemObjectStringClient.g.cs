...
{
    internal partial class TrakHoundHttpSystemObjectStringClient : TrakHoundHttpEntityClientBase<ITrakHoundObjectStringEntity>, ITrakHoundSystemObjectStringClient
    {




        public TrakHoundHttpSystemObjectStringClient(TrakHoundHttpClient baseClient, TrakHoundHttpSystemEntitiesClient entitiesClient) : base (baseClient, entitiesClient) 
        {
        }
            ...
            string routerId = null)
        {
            ...
            var url = Url.Combine(BaseUrl, TrakHoundHttp.GetEntityPath<ITrakHoundObjectStringEntity>());
            ...
            string routerId = null)
        {
            ...
            var url = TrakHoundHttp.GetEntityPath<ITrakHoundObjectStringEntity>();
            url = Url.Combine(url, route);


            var consumer = new TrakHoundEntityListClientConsumer<ITrakHoundObjectStringEntity>(BaseClient.ClientConfiguration, url, paths);
            consumer.Subscribe();
            return consumer;
        }
            ...
            string routerId = null)
        {
            ...
            var consumer = new TrakHoundEntityListClientConsumer<ITrakHoundObjectStringEntity>(BaseClient.ClientConfiguration, url, objectUuids);
            consumer.Subscribe();
            return consumer;
        }
