using System;
using System.Text;
using TrakHound.Blazor.Diagrams.Core.Extensions;
using Microsoft.AspNetCore.Components;

namespace TrakHound.Blazor.Diagrams.Components.Widgets;
...
public partial class GridWidget : IDisposable
{
    ...
    [Parameter] public string GridColor { get; set; } = "rgb(211 211 211)";
    ...
    private string GenerateStyle()
    {
        ...
        {
            case GridMode.Line:
                sb.Append($"background-image: linear-gradient({GridColor} 1px, transparent 1px), linear-gradient(90deg, {GridColor} 1px, transparent 1px);");
                break;
            case GridMode.Point:
