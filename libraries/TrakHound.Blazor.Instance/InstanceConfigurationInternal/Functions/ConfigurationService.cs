...
namespace TrakHound.Blazor.Instance.InstanceConfigurationInternal.Functions
{
    public class ConfigurationService
    {
        private const string _configurationCategory = TrakHoundFunctionConfiguration.ConfigurationCategory;
        ...
        public void Load()
        {
            ...
            if (configurationProfile != null)
            {
                ...
                var configurations = configurationProfile.Get<TrakHoundFunctionConfiguration>(_configurationCategory);
                if (!configurations.IsNullOrEmpty())
                {
                    foreach (var configuration in configurations)
                    {
                        ...
                        item.FunctionId = configuration.FunctionId;
                ...
                _tableItems = items.OrderBy(o => o.FunctionId);
            }
        }
        ...
        public async Task<ConfigurationAddResult> CreateConfiguration()
        {
            ...
            var createConfiguration = new TrakHoundFunctionConfiguration();
            createConfiguration.Id = !string.IsNullOrEmpty(AddConfiguration.Id) ? AddConfiguration.Id : Guid.NewGuid().ToString();
            createConfiguration.FunctionId = AddConfiguration.FunctionId;
            ...
            AddConfiguration.FunctionId = null;
        ...
        public void EditConfiguration(string configurationId)
        {
            ...
            if (configurationProfile != null)
            {
                var configuration = configurationProfile.Get<TrakHoundFunctionConfiguration>(_configurationCategory, configurationId);
                if (configuration != null)
                {
                    AddConfiguration.Id = configuration.Id;
                    AddConfiguration.FunctionId = configuration.FunctionId;
