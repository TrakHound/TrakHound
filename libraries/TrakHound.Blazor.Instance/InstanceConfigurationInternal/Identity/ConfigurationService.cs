...
namespace TrakHound.Blazor.Instance.InstanceConfigurationInternal.Identity
{
    public class ConfigurationService
    {
        private const string _configurationCategory = TrakHoundIdentityProviderConfiguration.ConfigurationCategory;
        ...
        public struct TableItem
        {
            ...
            public ITrakHoundIdentityProviderConfiguration Configuration { get; set; }
        }
        ...
        public void Load()
        {
            ...
            if (configurationProfile != null)
            {
                ...
                var configurations = configurationProfile.Get<TrakHoundIdentityProviderConfiguration>(_configurationCategory);
                ...
                _tableItems = items.OrderBy(o => o.Id);
            }
        }
        ...
        public async Task<ConfigurationAddResult> CreateConfiguration()
        {
            ...
            var createConfiguration = new TrakHoundIdentityProviderConfiguration();
            ...
            if (!AddConfiguration.Parameters.IsNullOrEmpty())
            {
        ...
        public void EditConfiguration(string configurationId)
        {
            ...
            if (configurationProfile != null)
            {
                var configuration = configurationProfile.Get<TrakHoundIdentityProviderConfiguration>(_configurationCategory, configurationId);
