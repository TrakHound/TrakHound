...
namespace TrakHound.Blazor.Instance.InstanceConfigurationInternal.Api
{
    public class ConfigurationService
    {
        private const string _configurationCategory = TrakHoundApiConfiguration.ConfigurationCategory;
        ...
        public void Load()
        {
            ...
            if (configurationProfile != null)
            {
                ...
                var configurations = configurationProfile.Get<TrakHoundApiConfiguration>(_configurationCategory);
        ...
        public async Task<ConfigurationAddResult> CreateConfiguration()
        {
            ...
            var createConfiguration = new TrakHoundApiConfiguration();
        ...
        public void EditConfiguration(string configurationId)
        {
            ...
            if (configurationProfile != null)
            {
                var configuration = configurationProfile.Get<TrakHoundApiConfiguration>(_configurationCategory, configurationId);
