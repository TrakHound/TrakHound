...
namespace TrakHound.Blazor.Instance.InstanceConfigurationInternal.Services
{
    public class ConfigurationService
    {
        private const string _configurationCategory = TrakHoundServiceConfiguration.ConfigurationCategory;
        ...
        public void Load()
        {
            ...
            if (configurationProfile != null)
            {
                ...
                var configurations = configurationProfile.Get<TrakHoundServiceConfiguration>(_configurationCategory);
                ...
                _tableItems = items.OrderBy(o => o.PackageId);
            }
        }
        ...
        public async Task<ConfigurationAddResult> CreateConfiguration()
        {
            ...
            var createConfiguration = new TrakHoundServiceConfiguration();
        ...
        public void EditConfiguration(string configurationId)
        {
            ...
            if (configurationProfile != null)
            {
                var configuration = configurationProfile.Get<TrakHoundServiceConfiguration>(_configurationCategory, configurationId);
