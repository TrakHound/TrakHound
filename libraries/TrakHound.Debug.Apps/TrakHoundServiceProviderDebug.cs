...
{
    internal class TrakHoundServiceProviderDebug : IServiceProvider
    {
        ...
        public TrakHoundServiceProviderDebug(string scopeId, ITrakHoundAppInjectionServiceManager serviceManager)
        {
            _scopeId = scopeId;
