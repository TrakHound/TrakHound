...
namespace TrakHound.Buffers
{
    public class TrakHoundEntityIndexBuffer<TEntity> : TrakHoundOperationBuffer<EntityIndexPublishRequest> where TEntity : ITrakHoundEntity
    {
        ...
        public TrakHoundEntityIndexBuffer(IEntityIndexUpdateDriver<TEntity> driver) : base(GetBufferId(driver), driver.Configuration.Id, GetBufferName(), _operationType, driver.Configuration.Buffer)
        {
            _driver = driver;
